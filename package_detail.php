...
if (isset($_POST['register'])) {
    ...
    if ($checkdate) {
        $_SESSION->set_message("
            <div class=\"alert alert-warning alert-dismissible fade show\" role=\"alert\">
              <strong><i class='mdi mdi-alert'></i></strong>  The wedding date you entered is already booked. Please try another date!
    ...
    if ($check_email) {
        $_SESSION->set_message("
            <div class=\"alert alert-warning alert-dismissible fade show\" role=\"alert\">
              <strong><i class='mdi mdi-alert'></i></strong>  Email already exists.
              <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                <span aria-hidden=\"true\">&times;</span>
              </button>
            </div>");
        ...
        if ($error == '') {
            ...
            $account_details->datetime_created = date("Y-m-d H:i:s");
